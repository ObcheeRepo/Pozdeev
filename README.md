Вот готовый `README.md`, который можно поместить в папку `AppProject`. Он описывает назначение проекта, пошаговый процесс работы с Git и итоговый результат слияния.
...
Скопируйте этот текст в файл `README.md` в корне папки `AppProject` и закоммитьте его в текущую ветку, если нужно.
